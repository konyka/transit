...
T_TEST(client_post_after_drop_needs_reopen) {
    ...
    T_ASSERT_EQ(t_client_dial(prod, loop, "127.0.0.1", port), 0);
    T_ASSERT_EQ(t_client_is_open(prod, "jobs"), 0);
    T_ASSERT_EQ(t_client_open_follow(prod, "jobs", T_CLIENT_OPEN_PRODUCER, 500), 0);
    T_ASSERT_EQ(t_client_is_open(prod, "jobs"), 1);
    {
        int64_t start = t_time_now_ms();
    ...
    T_ASSERT_EQ(t_client_is_open(prod, "jobs"), 0);
    T_ASSERT((t_client_open_flags(prod, "jobs") & T_CLIENT_OPEN_PRODUCER) != 0);
    T_ASSERT_EQ(t_client_dial(prod, loop, "127.0.0.1", port), 0);
    T_ASSERT_EQ(t_client_is_open(prod, "jobs"), 0);
...
T_TEST(client_join_after_drop_needs_reopen) {
    t_evloop *loop = t_evloop_create();
    t_broker *b = t_broker_create("n0");
    t_broker_start(b);
    t_server_config cfg;
...
T_TEST(client_close_after_drop_needs_reopen) {
    ...
    T_ASSERT_EQ(t_client_is_open(c, "jobs"), 1);
    {
        int64_t start = t_time_now_ms();
        while (t_client_is_connected(c) && t_time_now_ms() - start < 400)
            t_time_sleep_ms(5);
    ...
    T_ASSERT_EQ(t_client_is_connected(c), 0);
    T_ASSERT_EQ(t_client_is_open(c, "jobs"), 0);
    T_ASSERT_EQ(t_client_dial(c, loop, "127.0.0.1", port), 0);
...
T_TEST(client_unsubscribe_after_drop) {
    t_evloop *loop = t_evloop_create();
    t_broker *b = t_broker_create("n0");
    t_broker_start(b);
    t_server_config cfg;
...
T_TEST(client_unsubscribe_after_drop_drops_consumer) {
    t_evloop *loop = t_evloop_create();
    t_broker *b = t_broker_create("n0");
    t_broker_start(b);
    t_server_config cfg;
...
T_TEST(client_subscribe_follow_after_drop) {
    t_evloop *loop = t_evloop_create();
    t_broker *b = t_broker_create("n0");
    t_broker_start(b);
    t_server_config cfg;
    ...
    g_got = 0;
    T_ASSERT_EQ(t_client_subscribe_follow(cons, "jobs", on_net_msg, NULL, 0, 500), 0);
    T_ASSERT_EQ(t_client_subscribe_follow(cons, "jobs", on_net_msg, NULL, 0, 500), -1);
    {
        int64_t start = t_time_now_ms();
        while (t_client_is_connected(cons) && t_time_now_ms() - start < 400)
            t_time_sleep_ms(5);
...
T_TEST(client_confirm_per_queue) {
    t_evloop *loop = t_evloop_create();
    t_broker *b = t_broker_create("n0");
    t_broker_start(b);
    t_server_config cfg;
    ...
    T_ASSERT_EQ(t_client_dial(prod, loop, "127.0.0.1", port), 0);
    T_ASSERT_EQ(t_client_dial(cons, loop, "127.0.0.1", port), 0);
    T_ASSERT_EQ(t_client_subscribe_follow(cons, "a.q", on_net_msg, NULL, 0, 500), 0);
    T_ASSERT_EQ(t_client_subscribe_follow(cons, "b.q", on_net_msg, NULL, 0, 500), 0);
    g_got = 0;
    T_ASSERT_EQ(t_client_post_follow(prod, "a.q", (const uint8_t *)"a", 1, 0, 500), 0);
    T_ASSERT_EQ(t_client_post_follow(prod, "b.q", (const uint8_t *)"b", 1, 0, 500), 0);
    T_ASSERT(wait_flag_ge(&g_got, 2, 500));
    T_ASSERT_EQ(t_client_confirm(cons, "a.q"), 0);
    T_ASSERT_EQ(t_client_confirm(cons, "b.q"), 0);
    T_ASSERT_EQ(t_client_confirm(cons, "a.q"), -1);
    g_got = 0;
    T_ASSERT_EQ(t_client_post_follow(prod, "a.q", (const uint8_t *)"c", 1, 0, 500), 0);
    T_ASSERT(wait_flag_ge(&g_got, 1, 500));
    T_ASSERT_EQ(t_client_confirm(cons, "a.q"), 0);
...
T_TEST(client_confirm_same_queue_fifo) {
    t_evloop *loop = t_evloop_create();
    t_broker *b = t_broker_create("n0");
    t_broker_start(b);
    t_server_config cfg;
    ...
    T_ASSERT_EQ(t_client_subscribe_follow(cons, "jobs", on_net_msg, NULL, 0, 500), 0);
    g_got = 0;
    T_ASSERT_EQ(t_client_post_follow(prod, "jobs", (const uint8_t *)"1", 1, 0, 500), 0);
    T_ASSERT_EQ(t_client_post_follow(prod, "jobs", (const uint8_t *)"2", 1, 0, 500), 0);
    T_ASSERT(wait_flag_ge(&g_got, 2, 500));
    T_ASSERT_EQ(t_client_confirm(cons, "jobs"), 0);
    T_ASSERT_EQ(t_client_confirm(cons, "jobs"), 0);
    T_ASSERT_EQ(t_client_confirm(cons, "jobs"), -1);
    g_got = 0;
    T_ASSERT_EQ(t_client_post_follow(prod, "jobs", (const uint8_t *)"3", 1, 0, 500), 0);
    T_ASSERT(wait_flag_ge(&g_got, 1, 500));
    T_ASSERT_EQ(t_client_confirm(cons, "jobs"), 0);
...
T_TEST(client_confirm_after_unsubscribe) {
    t_evloop *loop = t_evloop_create();
    t_broker *b = t_broker_create("n0");
    t_broker_start(b);
    t_server_config cfg;
    ...
    T_ASSERT(wait_flag_ge(&g_got, 1, 500));
    T_ASSERT(t_client_last_push_id(cons) != 0);
    T_ASSERT_EQ(t_client_unsubscribe_follow(cons, "jobs", 500), 0);
    T_ASSERT_EQ(t_client_confirm(cons, "jobs"), -1);
...
T_TEST(client_confirm_after_broadcast_unsubscribe) {
    t_evloop *loop = t_evloop_create();
    t_broker *b = t_broker_create("n0");
    t_broker_start(b);
    t_server_config cfg;
    ...
    T_ASSERT_EQ(t_client_dial(prod, loop, "127.0.0.1", port), 0);
    T_ASSERT_EQ(t_client_dial(cons, loop, "127.0.0.1", port), 0);
    T_ASSERT_EQ(t_client_subscribe_follow(cons, "bc.q", on_net_msg, NULL,
                                          T_CLIENT_QTYPE_BROADCAST, 500), 0);
    g_got = 0;
    T_ASSERT_EQ(t_client_post_follow(prod, "bc.q", (const uint8_t *)"fan", 3, 0, 500), 0);
    T_ASSERT(wait_flag_ge(&g_got, 1, 500));
    T_ASSERT_EQ(t_client_unsubscribe_follow(cons, "bc.q", 500), 0);
    T_ASSERT_EQ(t_client_confirm(cons, "bc.q"), -1);
...
T_TEST(client_exclusive_released_on_drop) {
    t_evloop *loop = t_evloop_create();
    t_broker *b = t_broker_create("n0");
    t_broker_start(b);
    t_server_config cfg;
    ...
    T_ASSERT_EQ((int)t_client_queue_count(c2), 0);
    T_ASSERT_EQ(t_client_open_flags(c2, "ex.q"), -1);
    {
        int64_t start = t_time_now_ms();
    ...
    T_ASSERT_EQ(t_client_subscribe_follow(c2, "ex.q", on_net_msg, NULL,
                                          T_CLIENT_QFLAG_EXCLUSIVE, 500), 0);
    T_ASSERT_EQ(t_client_is_open(c2, "ex.q"), 1);
...
T_TEST(client_close_ack_does_not_ack_reopen) {
    t_evloop *loop = t_evloop_create();
    t_broker *b = t_broker_create("n0");
    t_broker_start(b);
    t_server_config cfg;
    ...
    t_client *c = t_client_create("reopen");
    T_ASSERT_EQ(t_client_dial(c, loop, "127.0.0.1", port), 0);
    T_ASSERT_EQ(t_client_last_ack_type(c), 0);
    T_ASSERT_EQ(t_client_open_follow(c, "jobs",
                                     T_CLIENT_OPEN_PRODUCER | T_CLIENT_QFLAG_AUTODELETE,
                                     500), 0);
    T_ASSERT_EQ(t_client_last_ack_type(c), (int)T_MSG_OPEN_QUEUE);
    T_ASSERT_EQ(t_client_is_open(c, "jobs"), 1);

    unsigned seq = t_client_ack_seq(c);
    T_ASSERT_EQ(t_client_close_queue(c, "jobs"), 0);
    T_ASSERT_EQ(t_client_open_queue(c, "jobs",
                                    T_CLIENT_OPEN_PRODUCER | T_CLIENT_QFLAG_DURABLE), 0);
    {
        int64_t start = t_time_now_ms();
        while (t_client_ack_seq(c) < seq + 2 && t_time_now_ms() - start < 500)
            t_time_sleep_ms(5);
    }
    T_ASSERT(t_client_ack_seq(c) >= seq + 2);
    T_ASSERT_EQ(t_client_last_ack_type(c), (int)T_MSG_OPEN_QUEUE);
    T_ASSERT_EQ(t_client_last_status(c), (int)T_ERR_IO);
    T_ASSERT_EQ(t_client_is_open(c, "jobs"), 0);
    T_ASSERT_EQ((int)t_client_queue_count(c), 0);
    T_ASSERT_EQ(t_client_post(c, "jobs", (const uint8_t *)"x", 1, 0), -1);
...
T_TEST(client_failed_exclusive_does_not_poison_producer) {
    ...
    T_ASSERT_EQ(t_client_subscribe_follow(c2, "ex.q", on_net_msg, NULL,
                                          T_CLIENT_QFLAG_EXCLUSIVE, 500), -1);
    T_ASSERT_EQ((int)t_client_queue_count(c2), 0);
    T_ASSERT_EQ(t_client_open_follow(c2, "ex.q", T_CLIENT_OPEN_PRODUCER, 500), 0);
    T_ASSERT_EQ(t_client_is_open(c2, "ex.q"), 1);
    T_ASSERT((t_client_open_flags(c2, "ex.q") & T_CLIENT_OPEN_CONSUMER) == 0);
    unsigned seq = t_client_ack_seq(c2);
    T_ASSERT_EQ(t_client_post(c2, "ex.q", (const uint8_t *)"x", 1, 0), 0);
    T_ASSERT(wait_ack_status(c2, seq, 0, 500));
...
T_TEST(client_failed_exclusive_reverts_producer_bits) {
    t_evloop *loop = t_evloop_create();
    t_broker *b = t_broker_create("n0");
    t_broker_start(b);
    t_server_config cfg;
    ...
    T_ASSERT_EQ(t_client_subscribe_follow(c2, "ex.q", on_net_msg, NULL,
                                          T_CLIENT_QFLAG_EXCLUSIVE, 500), -1);
    T_ASSERT_EQ(t_client_is_open(c2, "ex.q"), 1);
    T_ASSERT((t_client_open_flags(c2, "ex.q") & T_CLIENT_OPEN_PRODUCER) != 0);
    T_ASSERT((t_client_open_flags(c2, "ex.q") & T_CLIENT_OPEN_CONSUMER) == 0);
    unsigned seq = t_client_ack_seq(c2);
    T_ASSERT_EQ(t_client_post(c2, "ex.q", (const uint8_t *)"x", 1, 0), 0);
    T_ASSERT(wait_ack_status(c2, seq, 0, 500));
...
T_TEST(client_unsubscribe_follow_releases_exclusive) {
    t_evloop *loop = t_evloop_create();
    t_broker *b = t_broker_create("n0");
    t_broker_start(b);
    t_server_config cfg;
    ...
    T_ASSERT_EQ(t_client_subscribe_follow(c1, "ex.q", on_net_msg, NULL,
                                          T_CLIENT_QFLAG_EXCLUSIVE, 500), 0);
    T_ASSERT_EQ(t_client_unsubscribe_follow(c1, "ex.q", 500), 0);
    T_ASSERT_EQ(t_client_subscribe_follow(c2, "ex.q", on_net_msg, NULL,
                                          T_CLIENT_QFLAG_EXCLUSIVE, 500), 0);
...
T_TEST(client_unsubscribe_follow_keeps_producer) {
    t_evloop *loop = t_evloop_create();
    t_broker *b = t_broker_create("n0");
    t_broker_start(b);
    t_server_config cfg;
    ...
    g_got = 0;
    T_ASSERT_EQ(t_client_subscribe_follow(c, "jobs", on_net_msg, NULL, 0, 500), 0);
    T_ASSERT_EQ(t_client_unsubscribe_follow(c, "jobs", 500), 0);
    T_ASSERT_EQ((int)t_client_queue_count(c), 1);
    unsigned seq = t_client_ack_seq(c);
    T_ASSERT_EQ(t_client_post(c, "jobs", (const uint8_t *)"x", 1, 0), 0);
    T_ASSERT(wait_ack_status(c, seq, 0, 500));
...
T_TEST(client_join_replays_after_drop) {
    t_evloop *loop = t_evloop_create();
    t_broker *b = t_broker_create("n0");
    t_broker_start(b);
    t_server_config cfg;
...
T_TEST(client_subscribe_restores_all_opens_after_drop) {
    t_evloop *loop = t_evloop_create();
    t_broker *b = t_broker_create("n0");
    t_broker_start(b);
    t_server_config cfg;
    ...
    T_ASSERT_EQ(t_client_dial(cons, loop, "127.0.0.1", port), 0);
    T_ASSERT_EQ(t_client_subscribe_follow(cons, "a.q", on_net_msg, NULL, 0, 500), 0);
    T_ASSERT_EQ(t_client_subscribe_follow(cons, "b.q", on_out_msg, NULL, 0, 500), 0);
    {
        int64_t start = t_time_now_ms();
        while (t_client_is_connected(cons) && t_time_now_ms() - start < 400)
            t_time_sleep_ms(5);
    ...
    T_ASSERT_EQ(g_got, 0);
    T_ASSERT_EQ(t_client_post_follow(prod, "a.q", (const uint8_t *)"lo", 2, 0, 500), 0);
    T_ASSERT(wait_flag_ge(&g_got, 1, 500));
    T_ASSERT_EQ(g_got, 1);
...
T_TEST(client_broadcast_durable_invalid) {
    ...
    T_ASSERT_EQ((int)t_client_queue_count(c), 0);
    T_ASSERT_EQ(t_client_open_flags(c, "bc.q"), -1);
